...
function wpc_register_proscons_settings() {
    register_setting( 'wpc_settings_group', 'wpc_color_pros_bg', array( 'sanitize_callback' => 'sanitize_hex_color' ) );
    register_setting( 'wpc_settings_group', 'wpc_color_pros_text', array( 'sanitize_callback' => 'sanitize_hex_color' ) );
    register_setting( 'wpc_settings_group', 'wpc_color_cons_bg', array( 'sanitize_callback' => 'sanitize_hex_color' ) );
    register_setting( 'wpc_settings_group', 'wpc_color_cons_text', array( 'sanitize_callback' => 'sanitize_hex_color' ) );
    register_setting( 'wpc_settings_group', 'wpc_pros_icon', array( 'sanitize_callback' => 'sanitize_text_field' ) );
    register_setting( 'wpc_settings_group', 'wpc_cons_icon', array( 'sanitize_callback' => 'sanitize_text_field' ) );
    register_setting( 'wpc_settings_group', 'wpc_text_loading_proscons', array( 'sanitize_callback' => 'sanitize_text_field' ) );
}
